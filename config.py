...
# _C.MODEL.FLASH_INTERN_IMAGE = CN()
# _C.MODEL.FLASH_INTERN_IMAGE.DEPTHS = [2, 2, 6, 2]  # 从 [4, 4, 18, 4] 改为 [2, 2, 6, 2]
# _C.MODEL.FLASH_INTERN_IMAGE.GROUPS = [2, 4, 8, 16]  # 从 [4, 8, 16, 32] 改为 [2, 4, 8, 16]
# _C.MODEL.FLASH_INTERN_IMAGE.CHANNELS = 32  # 从 64 改为 32
# _C.MODEL.FLASH_INTERN_IMAGE.LAYER_SCALE = None
# _C.MODEL.FLASH_INTERN_IMAGE.OFFSET_SCALE = 0.5
# _C.MODEL.FLASH_INTERN_IMAGE.MLP_RATIO = 4.0
# _C.MODEL.FLASH_INTERN_IMAGE.CORE_OP = 'DCNv4'
